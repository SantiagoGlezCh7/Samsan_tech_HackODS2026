...
### 2026-04-13 | Claude Code | Configuración de repositorio y despliegue
- **Tarea:** Configurar GitHub Actions y GitHub Pages para despliegue automático del sitio Quarto.
- **Resultado:** Script de construcción y workflow de CI que exporta los notebooks a HTML y publica en `docs/`.
- **Decisión del equipo:** La selección de qué notebooks incluir en el dashboard y la estructura de carpetas fue definida por el equipo.

### 2026-04-13 | Claude Code | Homogenización visual de notebooks
- **Tarea:** Unificar paleta de colores, tipografía, librería de gráficas y estructura narrativa entre todos los notebooks del proyecto.
- **Resultado:** Paleta ODS (amarillo/guinda/azul), migración a Plotly, numeración consistente de gráficas y hallazgos clave por sección.
- **Decisión del equipo:** Los colores oficiales de las ODS 7, 8 y 14, la selección de indicadores a visualizar y la estructura narrativa fueron definidos por el equipo.

### 2026-04-13 | Claude Code | Corrección de visualización de gráficas
- **Tarea:** Resolver problema de visibilidad de gráficas Plotly en el entorno local de Jupyter.
- **Resultado:** Configuración del renderer para embeber el JS de Plotly directamente en el notebook, haciéndolo autocontenido.
- **Decisión del equipo:** El equipo evaluó las opciones de renderización y eligió la que garantizaba visualización sin dependencia de internet.

### 2026-04-14 | Claude Code | Integración de datos reales y corrección de interpretación
- **Tarea:** Sustituir datos provisionales por datos reales de DataMéxico; corregir interpretación de municipio con mayor tasa de desempleo.
- **Resultado:** Gráficas 2.1 y 2.2 conectadas a CSV de DataMéxico; gráfica 3.1 corregida para señalar correctamente a Minatitlán; hallazgos actualizados.
